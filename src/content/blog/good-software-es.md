...
Además, hay que tener en cuenta que no se pueden jugar algunos juegos con anticheat como: RIOT (LOL, Valorant), PUGB, EA (FIFA) en Linux debido al anticheat defectuoso y a la falta de compatibilidad nativa. Aquí hay una lista de [juegos de Steam compatibles con Linux o Steam Deck (basados en Arch-Linux con KDE)](https://www.protondb.com/) y aquí hay una lista de [juegos que utilizan anticheats y su compatibilidad con GNU/Linux o Wine/Proton](https://areweanticheatyet.com/). Para jugar a un juego en línea en Linux, se deben cumplir ambos requisitos.
